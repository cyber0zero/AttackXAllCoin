...
# -*- coding: utf-8 -*-
'''
Made by Mizogg Tools to Help Look for Bitcoin and ETH. Good Luck and Happy Hunting Miz_Tools_all_colour.py Version 2 Donations 3GCypcW8LWzNfJEsTvcFwUny3ygPzpTfL4
 29 Bitcoin & ETH Tools Using tatum.io API
made in Python with some Colour
https://mizogg.co.uk
'''
...
prompt=colour_purple + '''
    ...
    *                       Single Check Tools                                  *
    *    Option 1.Bitcoin Address with Balance & Info Check [OnLine]   =  1     *
    *    Option 2.Bitcoin Address to HASH160 Only Addresses starting 1 =  2     *
    *    Option 3.HASH160 to Bitcoin Address(Not Working) [OnLine]     =  3     *
    ...
    *    Option 7.Hexadecimal to Bitcoin Address with Balance Check[OnLine]= 7  *
    *    Option 8.Decimal to Bitcoin Address with Balance Check[OnLine]=  8     *
...
''' + colour_green + '''
    ...
    *    Option 24.ETH Address with Balance  Check      [Internet required]= 24 *
...
InputAPI = str(input('e53295a2-18a4-471a-99fa-17913bfe3921 : '))
#InputAPI = 'e53295a2-18a4-471a-99fa-17913bfe3921'
...
while True:
    ...
    **************[+] Starting.........Please Wait.....Bitcoin Address List Loading.....*******
        ...
        while start < stop:
            ...
            if caddrk2 in add or uaddrk2 in add or saddrk2 in add:
                ...
                if iteration % 10000 == 0:
                    print(f'It/CPU={iteration} checked={count} Address/Sec={addper} Hex={HEXk1} ')       
    elif start == 21:
        promptWIF= '''
    ...
    ************************* Mnemonic Words 12/15/18/21/24 tool *************************
        ...
        print(colour_red + "WRONG NUMBER!!! MUST CHOSE 1 - 29 " + colour_reset)
